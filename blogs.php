  ...
  <body>
    ...
    <div class="container-fluid navbar p-1" id="navbar">
      <div class="container">
        <div class="d-flex col-12 align-items-center">
          ...
          <span class="dk-only m-4 mr-0 mt-0 mb-0 item">Pagarbook</span>
          <span class="dk-only m-4 mr-0 mt-0 mb-0 item">Blog</span>
          <span class="dk-only m-4 mr-0 mt-0 mb-0 item">Contact</span>
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    <div class="col-md-4 p-3">
                        <div class="blog pt-2"  style="background: url(./admin/<?php echo $img; ?>) center;background:cover;">
                            <div class="dtime offset-8 col-4 align-items-center">
                                <h3 class="d-flex justify-content-end"> <?php echo $dop; ?> </h3>
                            </div>
                            <div class="blogdata">
    ...
    <script>
      if (
        ...
        document.getElementById('carousel-slide-1').src =
          './assets/slide-1-mob.jpg'
      }
    </script>
  </body>
</html>
