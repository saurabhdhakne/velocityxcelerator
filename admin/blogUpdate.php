                ...
                <!-- Content Column -->
                    <div class="col-xl-12 mb-4">
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <form action="blogUpdateData" method="POST" enctype="multipart/form-data" class="col-12" >
                                
                                <div class="form-group ">
                                    <label for="exampleInputEmail1 ">Title</label>
                                    <input type="text" name="title" class="form-control" id="title" aria-describedby="help" value="<?php echo $title; ?> " placeholder="Enter the title" required> 
                                </div>
